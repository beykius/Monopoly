...
const money = document.querySelectorAll('.money') as NodeListOf<HTMLElement>;
const message = document.querySelectorAll('.message') as NodeListOf<HTMLElement>;
const buttonsForBuying = document.querySelectorAll('.button-81') as NodeListOf<HTMLButtonElement>;
const playerOneCards = document.querySelector('.player-one-cards') as HTMLDivElement;
...
const createCard = (card: any) => {
    ...
    const cardHeader = cardElement.querySelector(".card-header") as HTMLDivElement;
    if (card.color) {
...
arr.forEach((row) => {
    row.forEach((cell) => {
        if (cell > 0 && cell <= cards.length) {
            ...
            const emptySpace = document.createElement("div") as HTMLDivElement;
...
function createPeople() {
    const playerOne = document.createElement("div") as HTMLDivElement;
    const playerTwo = document.createElement("div") as HTMLDivElement;
...
let playerPositions: number[] = [0, 0];


// Move player
function movePlayer(player: number, rollDice: number) {
    const currentCard = document.getElementById(`card-${playerPositions[player]}`);
    const playerElements = [
        document.querySelector('.player-one') as HTMLDivElement,
        document.querySelector('.player-two') as HTMLDivElement,
    ];
    let playerElement;
    if (player === 0) {
...
function buyHouse(){
    ...
    buttonHouse[1].onclick = function () {
            ...
            const houseElement = document.createElement("div") as HTMLDivElement;
...
let playerOneOwnedBrownCards:any = [];
let playerOneOwnedLightBlueCards:any = [];
let playerOneOwnedPinkCards:any = [];
let playerOneOwnedOrangeCards:any = [];
let playerOneOwnedRedCards:any = [];
let playerOneOwnedYellowCards:any = [];
let playerOneOwnedGreenCards:any = [];
let playerOneOwnedBlueCards:any = [];
let playerTwoOwnedBrownCards:any = [];
let playerTwoOwnedLightBlueCards:any = [];
let playerTwoOwnedPinkCards:any = [];
let playerTwoOwnedOrangeCards:any = [];
let playerTwoOwnedRedCards:any = [];
let playerTwoOwnedYellowCards:any = [];
let playerTwoOwnedGreenCards:any = [];
let playerTwoOwnedBlueCards:any = [];
...
// Roll Dice function
function rollDice() {
    const diceButtons = document.querySelectorAll('.roll-dice') as NodeListOf<HTMLButtonElement>;
    ...
    diceButtons.forEach((button, index) => {
        ...
        const placeholders = [
            ...
            document.getElementById(`placeholder-one`) as HTMLElement,
        ];
